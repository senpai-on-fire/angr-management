...
try:
    ...
    from patcherex.patches import AddCodePatch, AddLabelPatch, InsertCodePatch, Patch
except ImportError:
...
class AddStatePatch(Patch):
    ...
    def __init__(
        ...
        succ_states: Iterable[AbstractState] | None = None,
...
class EditDataPatch(Patch):
    ...
    def __init__(self, addr: int, data: bytes, old_data: bytes | None = None, name: str | None = None):
        super().__init__(name)
        self.addr = addr
        self.data = data
...
class EditInstrPatch(Patch):
    ...
    def __init__(self, addr: int, new_instr: str, name: str | None = None):
        super().__init__(name)
        self.addr = addr
...
class DataItemCause(CauseBase):
    ...
    def __init__(self, addr: int, data_type: str, data_size: int, name: str | None = None):
        self.addr = addr
...
def generate_patch(arch, causes: list[CauseBase]) -> Patch | None:
    # patches
